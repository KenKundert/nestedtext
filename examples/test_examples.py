...
def test_error_reporting():
    with cd(tests_dir / "errors"):
        ...
        expected = dedent("""\
            test error: test_cases.nt@3, 1›expected, expr=2**8: test failed.
                result=256 ≠ expected=255
            test error: test_cases.nt@5, 2›expr: invalid literal for int() with base 10: 'x'
                   5 ❬    expr: int('x')❭
            test error: test_cases.nt@8, 3›expr: '(' was never closed (<string>, line 1)
